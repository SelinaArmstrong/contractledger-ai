...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| Reduced contract-entry time by X%   | Repeated timed manual and assisted runs using the same fictional cases, with sample size and median reported. |
| Achieved X% extraction accuracy     | A completed, saved evaluation run with model, prompt, dataset version, field count, and baseline status.      |
